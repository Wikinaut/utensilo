...
A tiny online calculator for determining _utensilo_ dimensions from fabric sizes or vice versa.  
...
1. Enter available fabric size (fabric width x fabric height) → determine a range of possible and meaningful utensilo dimensions (height x width x depth)
...
Initially set up on 23.08.2026 by Wikinaut for Berlin Hack-and-Tell https://bhnt.c-base.org/ (Berlin Hack and Tell is a monthly(ish) meetup where eight entities can show their hacks at c-base space station every(ish) last Tuesday of the month).
